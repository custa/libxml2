...
Patch125:backport-Fix-return-value-of-xmlCharEncOutput.patch
Patch126:backport-Fix-buffering-in-xmlOutputBufferWrite.patch
...
%changelog
* Tue Dec 19 2023 fuanan <fuanan3@h-partners.com> - 2.9.10-37
- Type:bugfix
- CVE:NA
- SUG:NA
- DESC:backport upstream patches

* Mon Oct 16 2023 hehuazhen <hehuazhen@huawei.com> - 2.9.10-36
- Type:CVE
- CVE:CVE-2023-45322
- SUG:NA
- DESC:fix CVE-2023-45322

* Fri Sep 01 2023 liningjie <liningjie@xfusion.com> - 2.9.10-35
- Fix old SAX1 parser with custom callbacks

* Thu Apr 20 2023 BruceGW <gyl93216@163.com> - 2.9.10-34
- Type:CVE
- CVE:CVE-2023-28484 CVE-2023-29469
- SUG:NA
- DESC:fix CVE-2023-28484CVE-2023-29469

* Mon Nov 21 2022 fuanan <fuanan3@h-partners.com> - 2.9.10-33
- Type:bugfix
- CVE:NA
- SUG:NA
- DESC:backport upstream patches

* Tue Nov 08 2022 fuanan <fuanan3@h-partners.com> - 2.9.10-32
- fix CVE-2022-40303 CVE-2022-40304

* Wed Sep 14 2022 hubin <hubin73@huawei.com> - 2.9.10-31
...
* Fri Jun 24 2022 fuanan <fuanan3@h-partners.com> - 2.9.10-28
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:Fix memory leaks in xmlACatalogAdd when xmlHashAddEntry failed

* Thu Jun 16 2022 fuanan <fuanan3@h-partners.com> - 2.9.10-27
- Type:bugfix
- ID:NA
- SUG:NA
- DESC:Fix memory leaks for xmlACatalogAdd

* Mon May 09 2022 fuanan <fuanan3@h-partners.com> - 2.9.10-26
- Type:CVE
- ID:CVE-2022-29824
- SUG:NA
- DESC:fix CVE-2022-29824

* Wed Mar 09 2022 fuanan <fuanan3@h-partners.com> - 2.9.10-25
- Type:CVE
- ID:CVE-2022-23308
- SUG:NA
- DESC:fix CVE-2022-23308

* Sat Feb 26 2022 fuanan <fuanan3@h-partners.com> - 2.9.10-24
- fix valgrind errors in xmlParseBalancedChunkMemoryRecover

* Fri Feb 11 2022 fuanan <fuanan3@h-partners.com> - 2.9.10-23
- Type:bugfix
- ID:NA
- SUG:NA
